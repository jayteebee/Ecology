export const FEATURES_HEADER = {
  ...
  SUBHEADER:
    "The importance of this topic has grown due to the latest changes in bat survey guidelines, now advising the use of thermal vision cameras.",
};
...
export const ZIGZAG_ITEM_CONTENT = [
  {
    ...
    BULLET_TWO:
      "A variety of lenses (6, 14, 24, 42 or 80 degree), ensuring coverage down a long hedge row or a wide gable wall.",
    BULLET_THREE: "A heavy duty Manfrotto tripod.",
    BULLET_FOUR: "A power supply for up to 6 hours filming.",
    BULLET_FIVE:
      "A Windows Touchpad device for remote image streaming and camera control (any laptop can be used if preferred).",
  },
  {
    ...
    BULLET_ONE:
      "Simplify the software for you, showing you the options you need to get the job done.",
    BULLET_TWO:
      "Show timestamps, replay events, and trigger recording only when a bat is present.",
    BULLET_THREE:
      "Enable single bat tracking through its entire flight path, showing definitive emergence.",
  },
  {
    ...
    BULLET_ONE:
      "On a complex project, where one camera could replace the manpower of 5+ people.",
    BULLET_TWO:
      "When use of external light sources could affect bat behaviour.",
  ...
  },
  {
    ...
    BULLET_TWO:
      "Ability to record, analyse and interpret your survey in real time or in post processing",
    BULLET_THREE:
      "Access to the exact time and date an event occurs, such as a bat emerging from a roost",
    BULLET_FOUR:
...
export const MAP_HEADER = {
  INTRO:
    "We always love to meet our customers face to face, so why not book an appointment today. We have a modern conference room and training facilities at our office in Bristol. Contact us at",
  TRAIN: "By Train",
  PLANE: "By Plane",
  CAR: "By Car",
